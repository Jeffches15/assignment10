...
class User(Base):
    ...
    def register(cls, db, user_data: Dict[str, Any]) -> "User":
        ...
        try:
            ...
            # Sends pending changes to the database, but does NOT commit them.
            # db.commit() makes these changes permanent
            # these changes will be discarded if:
                # The request ends
                # The session is closed
                # Or the app/server exits or crashes
            db.flush()
            return new_user
